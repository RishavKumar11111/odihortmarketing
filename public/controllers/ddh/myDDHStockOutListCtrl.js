app.controller('myDDHStockOutListCtrl', function ($scope, $http, $filter) {
    ...
    $scope.getStockOutDetails = function () {
        ...
        $http.get('http://localhost:3000/ddh/getStockOutDetails?blockCode=' + $scope.ddlBlocks + '&categoryID=' + $scope.ddlCategories + '&areaType=' + $scope.rbAreaType + '&itemID=' + $scope.ddlItems + '&dateFrom=' + dateFrom + '&dateTill=' + dateTill).then(function success(response) {
